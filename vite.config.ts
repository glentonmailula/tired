// Vite's runtime package is resolved by the Vite CLI; keep config type-checking
// working in environments where its declarations are not available.
import { defineConfig, type ConfigEnv, type HtmlTagDescriptor, type Plugin, type ViteDevServer } from 'vite'
import react from '@vitejs/plugin-react'
import tailwindcss from '@tailwindcss/vite'
import path from 'node:path'
import type { IncomingMessage, ServerResponse } from 'node:http'

// The Figma-generated site configuration is optional and may not exist in
